...
<center>
   <h1> REPORTEE DETTALADO DE CONTABILIDAD POR FECHA</h1>
   <br><br/>
<br><br/>
<br><br/>
 ...
 <div class="container-fluid">
  <div class="row">
   <div class="col-md-6 col-sm-6 col-xs-12">
                  ...
                  <form id="loginform" autocomplete="off" method="post" action="<?php echo base_url('index.php/reportesdecontabilidad/reportesdetallados'); ?>">
                             ...
                             <br></br>
                              ...
                              <div class="pull-right">
                                 ...
                                 <button class="btn btn-primary btn-lg" type="submit">GENERAR REPORTES</button>
